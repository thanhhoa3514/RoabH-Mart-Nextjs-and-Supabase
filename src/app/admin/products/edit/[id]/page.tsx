    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            setFormData({
                ...
                price: '1299.00',
                description: 'High-performance laptop with 16GB RAM, 512GB SSD, and dedicated graphics card. Features a stunning 15.6" display, backlit keyboard, and all-day battery life.',
                stock: '34',
                status: 'In Stock',
                featured: true
            });
